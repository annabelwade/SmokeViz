...
def plot_test_results_smokeviz(pred, fn, save_fig = False):
    ...
    if save_fig:
        results_dir = '/scratch1/RDARCH/rda-ghpcs/Rey.Koki/SmokeViz_code/paper_figures/scripts/results/'
...
def plot_exp_test_results(exp_num_list, test_fn, test_idx, 
    ...
    data_loc = '/scratch1/RDARCH/rda-ghpcs/Annabel.Wade/semantic_segmentation_smoke/data/sample_data/'
